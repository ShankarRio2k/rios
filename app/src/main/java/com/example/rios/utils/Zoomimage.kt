...
class Zoomimage : androidx.appcompat.widget.AppCompatImageView {
    ...
    private fun initView() {
        ...
        tapDetector = GestureDetector(context, object : GestureDetector.SimpleOnGestureListener() {
            ...
            override fun onSingleTapConfirmed(e: MotionEvent): Boolean {
                onClickListener?.onClick(this@Zoomimage)
                return true
            }

            override fun onLongPress(e: MotionEvent) {
                onLongClickListener?.onLongClick(this@Zoomimage)
            }
            ...
            override fun onFling(
                ...
                ViewCompat.postOnAnimation(this@Zoomimage, flingRunnable)
                return true
            }
    ...
    private val flingRunnable = object : Runnable {
        ...
        override fun run() {
            if (!scroller.isFinished && scroller.computeScrollOffset()) {
                ...
                lastX = curX
                lastY = curY
                ViewCompat.postOnAnimation(this@Zoomimage, this)
            }
        }
    }
    ...
    override fun onTouchEvent(event: MotionEvent?): Boolean {
        ...
        return event?.let { tapDetector.onTouchEvent(it) } == true || event?.let {
